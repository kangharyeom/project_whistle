...
const MatchCategory = () => {
  ...
  const handleClickRecruit = () => {
    window.location.href = `${basicURL}/ranking/lowst`;
  };
    ...
    <StyledCategory id = 'StyledCategory'>
      <CategoryContainer id = 'CategoryContainer'>
        <CategoryMiddle id = 'CategoryMiddle'>
          ...
          {
          <>
            <Button variant="contained" sx={{backgroundColor: "white", color: "#064452",  fontWeight: "bold",  fontSize: "14px", width:'30%'}} size="small" onClick={handleClickTeamInfo}>상위 점수</Button>
            <Button variant="contained" sx={{backgroundColor: "white", color: "#064452",  fontWeight: "bold",  fontSize: "14px", width:'30%'}} size="small" onClick={handleClickRecruit}>하위 점수</Button>
          </>
          }
          </ButtonGroup>
        </CategoryMiddle>
